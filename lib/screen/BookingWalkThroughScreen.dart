...
class _BookingWalkThroughState extends State<BookingWalkThrough> {
  ...
  var titles = [Booking_lbl_Walk1Title, Booking_lbl_Walk2Title, Booking_lbl_Walk3Title];

  var subTitles = [Bookking_lbl_Walk1SubTitle, Bookking_lbl_Walk1SubTitle, Bookking_lbl_Walk1SubTitle];
          ...
          Positioned(
            ...
            child: Align(
              ...
              child: DotsIndicator(
                ...
                decorator: DotsDecorator(color: Booking_greyColor, activeColor: Booking_Primary),
              ),
            ),
          ),
          Positioned(
                ...
                children: <Widget>[
                  Center(
                    child: Text(
                      ...
                      style: primaryTextStyle(fontFamily: fontRegular, size: 14, color: Booking_TextColorSecondary),
